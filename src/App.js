  ...
  render() {
    ...
    const person = {
      ...
      experience: [
        ...
        {jobTitle: 'Web Developer', company: 'Aszende', startDate: 'Abr 2020', endDate: 'Actualidad', jobDescription: '<ul><li> Development of internal applications. </li><li> Design and creation from scratch of PHP-Symfony projects based on Rest API </li><li> Use of Symfony Framework with versions:<ul><li>2.8</li><li>4.4</li><li>5.1</li></ul></li><li>Migration of projects to Docker containers</li><li>Migration of servers to Azure cloud environment with Docker containers</li></ul>'},
